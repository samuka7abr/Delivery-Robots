 ...
 *
 * A leitura dos dados compartilhados é feita direto nas structs, sem trava
 * nova (ver comentário em idp.h). A sincronização com as threads entra na
 * Issue #9; aqui cada frame é composto por inteiro e só então enviado à tela
 * num único refresh, evitando que a tela seja corrompida no meio do desenho.
 *
